...
export default function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const heroElement = document.getElementById("app-element-6");
      if (heroElement) {
        const rect = heroElement.getBoundingClientRect();
        setIsSecondaryNavVisible(rect.bottom <= 50);
      }
    };
  ...
  return (
    <>
      <div id="root">
        <a
          className="app-element-2"
          href="#?modal=PHOTO_TOUR_SCROLLABLE#main"
        >
          Skip to content
        </a>
        <header className="header-siteheader" id="siteHeader">
          <div className="header-div-2">
            ...
            <div className="header-div" role="search">
              <button className="header-button" type="button">
                <img
                  className="header-element-5"
                  src="/photos/icons/searchbar-house.png"
                  alt=""
                  aria-hidden="true"
                />
                Anywhere
              ...
              <span className="header-span-2"></span>
              <button className="header-button header-button-2" type="button">
                Add guests
              </button>
              <button
                className="header-element-3"
                type="button"
                aria-label="Search"
              ></button>
            </div>
            <nav className="header-nav">
              ...
              <button
                className="header-element-2 header-element"
                type="button"
          ...
          <div className="app-div-16">
            ...
            <div className="app-div-12">
              <div className="app-contentleft" id="contentLeft">
                <div className="listinginfo-div-9">
                  <h2>Entire serviced apartment in Candolim, India</h2>
                  <div className="listinginfo-div-13">
                    3 guests · 1 bedroom · 1 bed · 1 bathroom
                  </div>
                </div>
                <div className="listinginfo-div-4">
                  <div className="listinginfo-div-14">
                    <span className="listinginfo-span-2">
                      <svg
                        style={{
                          display: "block",
                          height: "100%",
                    ...
                    <span className="listinginfo-span">
                      Guest
                      <br />
                      favourite
                    </span>
                    <span className="listinginfo-span-2 listinginfo-span-3">
                      <svg
                        style={{
                          display: "block",
                          height: "100%",
                  ...
                  <div className="listinginfo-div-7">
                    One of the most loved homes on Airbnb, according to guests
                  </div>
                  <div className="listinginfo-div-2">
                    <div className="listinginfo-div-6">
                      <div className="hostsection-2">4.95</div>
                      <div className="reviewssection-span">
                        <span>
                          <svg
                            viewBox="0 0 32 32"
                            aria-hidden="true"
                    ...
                    <div className="listinginfo-div-8"></div>
                    <div className="listinginfo-div-6">
                      <div className="hostsection-2">19</div>
                      <div className="hostsection-rating">Reviews</div>
                    </div>
                  </div>
                </div>
                <div className="listinginfo-div-3">
                  <img
                    className="listinginfo-element-3"
                    src="/photos/avatars/host-mirashya-homes.jpeg"
                    alt=""
                  />
                  <div>
                    <div className="reviewssection-mohd">Hosted by Mirashya Homes</div>
                    <div className="meta">2 years hosting</div>
                  </div>
                </div>
                <div
                  className="listinginfo-element-2"
                  style={{
                    borderTop: "1px solid var(--line-soft)",
                    paddingTop: "32px",
                  }}
                >
                  <div className="listinginfo-div-12">
                    <div className="listinginfo-div-15">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                        aria-hidden="true"
                    ...
                    <div className="listinginfo-div">
                      <div className="listinginfo-living-room">Outdoor entertainment</div>
                      <div className="listinginfo-div-10">
                  ...
                  <div className="listinginfo-div-12">
                    ...
                    <div className="listinginfo-div">
                      <div className="listinginfo-living-room">Designed for staying cool</div>
                      <div className="listinginfo-div-10">
                  ...
                  <div className="listinginfo-div-12">
                    ...
                    <div className="listinginfo-div">
                      <div className="listinginfo-living-room">Self check-in</div>
                      <div className="listinginfo-div-10">
                ...
                <div
                  className="listinginfo-element"
                  style={{ borderTop: "1px solid var(--line-soft)" }}
                >
                  <div className="listinginfo-div-16">
                    <span>
                  ...
                  <p id="descText" className={isDescExpanded ? "" : "listinginfo-desctext"}>
                    🌴 Plan Your Relaxing Holiday at Amor De Goa by Mirashya
                    Homes! ✨ Stay in this cozy 1BHK in the heart of Candolim,
                    featuring a private jacuzzi 🛁 for the perfect unwind.
                    <br />
                    Enjoy high-speed WiFi 💻, Smart TV 📺, pet-friendly comfort
                    🐾, and stylish interiors. Just minutes from Candolim Beach
                    🏖️, popular cafés, restaurants, and nightlife 🍹, it’s ideal
                    for couples seeking romance, relaxation, and a touch of
                    luxury in North Goa. ❤️🌴
                  </p>
                  <button
                    className="locationsection-button"
                    id="descMore"
                    onClick={() => setIsDescExpanded(!isDescExpanded)}
                  >
                    {isDescExpanded ? "Show less" : "Show more"}{" "}
                    <span
                      className="locationsection-span"
                      style={{
                        transform: isDescExpanded
                          ? "rotate(-90deg)"
                          : "rotate(90deg)",
                ...
                <div className="app-div-4">
                  <h2 className="app-things-to-know">Where you'll sleep</h2>
                  <div className="listinginfo-div-5">
                    <div className="listinginfo-div-11">
                      <img
                        src="/photos/tour/bedroom/bedroom-01-main.jpeg"
                        alt=""
                      />
                      <div className="listinginfo-living-room">Bedroom</div>
                      <div className="listinginfo-div-10">1 double bed</div>
                    </div>
                    <div className="listinginfo-div-11">
                      <img
                        src="/photos/tour/living-room-1/living-room-1-02-sofa-view.jpeg"
                        alt=""
                      />
                      <div className="listinginfo-living-room">Living room</div>
                      <div className="listinginfo-div-10">1 sofa</div>
                    </div>
                  </div>
                </div>
                <div className="app-div-4" id="amenities">
                  <h2 className="app-things-to-know">What this place offers</h2>
                  <div className="amenitiessection-div-2">
                    <div className="amenitiessection-div-3">
                      <span className="ico">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 32 32"
                    ...
                    <div className="amenitiessection-div-3">
                      ...
                      <span className="label">Dedicated workspace</span>
                    </div>
                    <div className="amenitiessection-div-3">
                      <span className="ico">
                        <svg
                      ...
                      <span className="label">Free parking on premises</span>
                    </div>
                    <div className="amenitiessection-div-3">
                      <span className="ico">
                        <svg
                    ...
                    <div className="amenitiessection-div-3">
                      ...
                      <span className="label">Hot tub</span>
                    </div>
                    <div className="amenitiessection-div-3">
                      <span className="ico">
                        <svg
                    ...
                    <div className="amenitiessection-div-3 amenitiessection-div">
                      <span className="ico">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 32 32"
                      ...
                      <span className="label">Carbon monoxide alarm</span>
                    </div>
                    <div className="amenitiessection-div-3 amenitiessection-div">
                      <span className="ico">
                        <svg
                      ...
                      <span className="label">Smoke alarm</span>
                    </div>
                  </div>
                  <button className="amenitiessection-showamen" id="showAmen">
            ...
            <div className="app-widesections" id="wideSections">
              <section className="app-section" id="reviews">
                <div className="reviewssection-div-8">
                  <div className="reviewssection-div-2">
                    <img src="/photos/icons/laurel-left.png" alt="" />
                    <div className="reviewssection-4-95">4.95</div>
                    <img src="/photos/icons/laurel-right.png" alt="" />
                  </div>
                  <div className="reviewssection-guest-favourite">Guest favourite</div>
                  <div className="reviewssection-div-7">
                    This home is a guest favourite based on ratings, reviews and
                    reliability
                  </div>
                  <button className="reviewssection-how-reviews-work">How reviews work</button>
                </div>
                <div className="reviewssection-div">
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Overall rating</div>
                    <div className="reviewssection-div-9">
                      <div className="reviewssection-div-3">
                        <span className="reviewssection-1">5</span>
                        <div className="reviewssection-div-10">
                          <div
                            className="reviewssection-element-5"
                            style={{ width: "95%" }}
                          ></div>
                        </div>
                      </div>
                      <div className="reviewssection-div-3">
                        <span className="reviewssection-1">4</span>
                        <div className="reviewssection-div-10">
                          <div
                            className="reviewssection-element-5"
                            style={{ width: "5%" }}
                      ...
                      <div className="reviewssection-div-3">
                        <span className="reviewssection-1">3</span>
                        <div className="reviewssection-div-10">
                          <div
                            className="reviewssection-element-5"
                            style={{ width: "0%" }}
                      ...
                      <div className="reviewssection-div-3">
                        <span className="reviewssection-1">2</span>
                        <div className="reviewssection-div-10">
                          <div
                            className="reviewssection-element-5"
                            style={{ width: "0%" }}
                      ...
                      <div className="reviewssection-div-3">
                        <span className="reviewssection-1">1</span>
                        <div className="reviewssection-div-10">
                          <div
                            className="reviewssection-element-5"
                            style={{ width: "0%" }}
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Cleanliness</div>
                    <div className="reviewssection-4-8">5.0</div>
                    <div className="ico">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Accuracy</div>
                    <div className="reviewssection-4-8">5.0</div>
                    <div className="ico">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Check-in</div>
                    <div className="reviewssection-4-8">5.0</div>
                    <div className="ico">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Communication</div>
                    <div className="reviewssection-4-8">5.0</div>
                    <div className="ico">
                      <svg
                        viewBox="0 0 32 32"
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Location</div>
                    <div className="reviewssection-4-8">4.8</div>
                    <div className="ico">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
                  ...
                  <div className="reviewssection-div-12">
                    <div className="reviewssection-check-in">Value</div>
                    <div className="reviewssection-4-8">4.8</div>
                    <div className="ico">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="reviewssection-div-11">
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/indoor-spaces.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Comfort <span className="reviewssection-2">6</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/accuracy.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Accuracy <span className="reviewssection-2">5</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/hot-tub.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Hot tub <span className="reviewssection-2">5</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/condition.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Condition <span className="reviewssection-2">4</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/hospitality.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Hospitality <span className="reviewssection-2">8</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/cleanliness.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Cleanliness <span className="reviewssection-2">4</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/amenities.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Amenities <span className="reviewssection-2">2</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/decor.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Decor <span className="reviewssection-2">2</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      ...
                      aria-hidden="true"
                    />
                    Indoor spaces <span className="reviewssection-2">2</span>
                  </button>
                  <button className="reviewssection-button">
                    <img
                      className="reviewssection-element-3"
                      src="/photos/icons/location.png"
                      alt=""
                      aria-hidden="true"
                    />
                    Location <span className="reviewssection-2">2</span>
                  </button>
                </div>
                <div className="reviewssection-div-5">
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <div
                        className="reviewssection-element-2"
                        style={{
                          background: "rgb(247, 237, 226)",
                          color: "rgb(193, 133, 42)",
                        }}
                      >
                        A
                      </div>
                      <div>
                        <div className="reviewssection-mohd">Amit</div>
                        <div className="reviewssection-4-years-on-airbnb">2 months on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                      <span className="reviewssection-span">
                        <span>
                          <svg
                            viewBox="0 0 32 32"
                            aria-hidden="true"
                    ...
                    <div
                      className="reviewssection-element"
                      data-full="Very%20helpful%20and%20responsive%20team.%20Safe%20and%20peaceful%20stay.%20loved%20everything%20about%20the%20property."
                    >
                  ...
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <img
                        className="reviewssection-element-4"
                        src="/photos/avatars/reviewer-01.jpeg"
                        alt=""
                      />
                      <div>
                        <div className="reviewssection-mohd">Aheesh</div>
                        <div className="reviewssection-4-years-on-airbnb">3 years on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                      <span className="reviewssection-span">
                    ...
                    <div
                      className="reviewssection-element listinginfo-desctext"
                      data-full="We%20had%20a%20wonderful%20stay.%20The%20apartment%20was%20clean%2C%20comfortable%2C%20and%20exactly%20as%20shown%20in%20the%20photos.%20The%20host%20was%20very%20responsive%20and%20helpful%20throughout%20our%20stay.%20We%20would%20definitely%20recommend%20this%20place%20and%20would%20love%20to%20stay%20here%20again."
                    >
                      We had a wonderful stay. The apartment was clean,
                      comfortable, and exactly as shown in the photos. The host
                      was very responsive and helpful throughout our stay. We
                      would definitely recommend this place and would love to
                      stay here again.
                    </div>
                    <button className="reviewssection-show-more">Show more</button>
                  </div>
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <img
                        className="reviewssection-element-4"
                        src="/photos/avatars/reviewer-02.jpeg"
                        alt=""
                      />
                      <div>
                        <div className="reviewssection-mohd">Samiksha</div>
                        <div className="reviewssection-4-years-on-airbnb">8 months on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                      <span className="reviewssection-span">
                    ...
                    <div
                      className="reviewssection-element"
                      data-full="the%20host%20nitish%20was%20really%20great%20help"
                    >
                  ...
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <div
                        className="reviewssection-element-2"
                        style={{
                          background: "rgb(239, 234, 247)",
                          color: "rgb(139, 111, 196)",
                        }}
                      >
                        V
                      </div>
                      <div>
                        <div className="reviewssection-mohd">Vedant</div>
                        <div className="reviewssection-4-years-on-airbnb">4 years on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                      <span className="reviewssection-span">
                    ...
                    <div
                      className="reviewssection-element listinginfo-desctext"
                      data-full="We%20had%20an%20amazing%20stay%20at%20this%20property%20in%20Goa!%20The%20entire%20home%20was%20spotless%20and%20exceptionally%20well-maintained%2C%20making%20us%20feel%20comfortable%20from%20the%20moment%20we%20arrived.%20The%20cleanliness%20standards%20were%20truly%20impressive%2C%20with%20every%20corner%20of%20the%20house%20looking%20fresh%20and%20pristine.%0AThe%20highlight%20of%20our%20stay%20was%20definitely%20the%20jacuzzi.%20It%20was%20clean%2C%20well-kept%2C%20and%20the%20perfect%20place%20to%20relax%20after%20a%20day%20of%20exploring%20Goa.%20It%20added%20a%20luxurious%20touch%20to%20our%20vacation%20and%20made%20our%20experience%20even%20more%20memorable.%0AThe%20property%20was%20exactly%20as%20described%2C%20well-equipped%2C%20and%20offered%20a%20peaceful%20atmosphere.%20We%20would%20highly%20recommend%20this%20place%20to%20anyone%20looking%20for%20a%20comfortable%2C%20clean%2C%20and%20relaxing%20stay%20in%20Goa.%20Looking%20forward%20to%20visiting%20again!"
                    >
                      We had an amazing stay at this property in Goa! The entire
                      home was spotless and exceptionally well-maintained,
                      making us feel comfortable from the moment we arrived. The
                      cleanliness standards were truly impressive, with every
                      corner of the house looking fresh and pristine. The
                      highlight of our stay was definitely the jacuzzi. It was
                      clean, well-kept, and the perfect place to relax after a
                      day of exploring Goa. It added a luxurious touch to our
                      vacation and made our experience even more memorable. The
                      property was exactly as described, well-equipped, and
                      offered a peaceful atmosphere. We would highly recommend
                      this place to anyone looking for a comfortable, clean, and
                      relaxing stay in Goa. Looking forward to visiting again!
                    </div>
                    <button className="reviewssection-show-more">Show more</button>
                  </div>
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <img
                        className="reviewssection-element-4"
                        src="/photos/avatars/reviewer-03.jpeg"
                        alt=""
                      />
                      <div>
                        <div className="reviewssection-mohd">Vaibhav S</div>
                        <div className="reviewssection-4-years-on-airbnb">3 years on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                    ...
                    <div
                      className="reviewssection-element"
                      data-full="Great%20great%20experience%20living%20out%20there%20%2C%20can&#39;t%20expect%20more%20%2C%20will%20always%20look%20for%20it%20in%20the%20future%20and%20will%20recommend%20my%20friends%20too."
                    >
                      Great great experience living out there , can't expect
                      more , will always look for it in the future and will
                      recommend my friends too.
                    </div>
                  </div>
                  <div className="reviewssection-div-4">
                    <div className="head">
                      <img
                        className="reviewssection-element-4"
                        src="/photos/avatars/reviewer-04.jpeg"
                        alt=""
                      />
                      <div>
                        <div className="reviewssection-mohd">Mohd</div>
                        <div className="reviewssection-4-years-on-airbnb">5 years on Airbnb</div>
                      </div>
                    </div>
                    <div className="reviewssection-div-6">
                      <span className="reviewssection-span">
                    ...
                    <div
                      className="reviewssection-element"
                      data-full="Great%20place.%20Exactly%20as%20described%20in%20the%20listing."
                    >
                      Great place. Exactly as described in the listing.
                    </div>
                  </div>
                </div>
                <button className="amenitiessection-showamen">Show all 19 reviews</button>
              </section>
              ...
              <section className="app-section">
                <h2 className="app-things-to-know">Meet your host</h2>
                <div className="hostsection-div-4">
                  <div>
                    <div className="hostsection-div-8">
                      <div className="hostsection-div-2">
                        <div className="hostsection-div-12">
                          <img
                            src="/photos/avatars/host-mirashya-homes.jpeg"
                            alt=""
                          />
                          <span className="hostsection-span">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 32 32"
                              aria-hidden="true"
                        ...
                        <div className="hostsection-mirashya-homes">Mirashya Homes</div>
                        <div className="hostsection-host">Host</div>
                      </div>
                      <div className="hostsection-div-3">
                        <div className="hostsection-div-10">
                          <div className="hostsection-2">1,463</div>
                          <div className="hostsection-rating">Reviews</div>
                        </div>
                        <div className="hostsection-div-10">
                          <div className="hostsection-2">4.68★</div>
                          <div className="hostsection-rating">Rating</div>
                        </div>
                        <div className="hostsection-div-10">
                          <div className="hostsection-2">2</div>
                          <div className="hostsection-rating">Years hosting</div>
                        </div>
                      </div>
                    </div>
                    <div className="hostsection-div">
                      <div className="hostsection-div-9">
                        <span className="ico">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                  ...
                  <div>
                    <div className="hostsection-co-hosts">Co-Hosts</div>
                    <div className="hostsection-div-6">
                      <div className="hostsection-div-11">
                        <img src="/photos/avatars/cohost-01.jpg" alt="" />
                        <span>Sharath</span>
                      </div>
                      <div className="hostsection-div-11">
                        <img src="/photos/avatars/cohost-02.jpg" alt="" />
                        <span>Aman Dev Pahwa</span>
                      </div>
                      <div className="hostsection-div-11">
                        <img src="/photos/avatars/cohost-03.jpg" alt="" />
                        <span>Maria Karen Priyanka</span>
                      </div>
                      <div className="hostsection-div-11">
                        <img src="/photos/avatars/cohost-01.jpg" alt="" />
                        <span>Simran</span>
                    ...
                    <div className="hostsection-host-details">Host details</div>
                    <div className="hostsection-div-7">
                      Response rate: 100%
                      <br />
                      Responds within an hour
                    </div>
                    <button className="hostsection-message-host">Message host</button>
                    <div className="hostsection-div-5">
                      <span className="ico">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 32 32"
        ...
        >
          <header className="phototour-header" id="tourBar">
            <button
              className="phototour-div-8 phototour-close"
              type="button"
              aria-label="Back"
              id="tourBack"
            >
            ...
            <h2 className="phototour-photo-tour">Photo tour</h2>
            <div className="phototour-div-7">
              <button className="phototour-close" type="button" aria-label="Share">
                <span>
                  <svg
                    viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <button className="phototour-close" type="button" aria-label="Save">
                <span>
                  <svg
                    viewBox="0 0 32 32"
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="phototour-div-3" id="tourScroll">
            <div className="phototour-div-9">
              <nav
                className="phototour-photo-categories"
                id="tourNav"
              ...
              >
                ...
                >
                  <img
                    ...
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Living room 1</span>
                </button>
                <button
                  className="phototour-element-2"
                  type="button"
                  aria-label="Living room 2"
                >
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Living room 2</span>
                </button>
                <button
                  className="phototour-element-2"
                  type="button"
                  aria-label="Full kitchen"
                >
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Full kitchen</span>
                </button>
                <button className="phototour-element-2" type="button" aria-label="Bedroom">
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Bedroom</span>
                </button>
                <button
                  className="phototour-element-2"
                  type="button"
                  aria-label="Full bathroom"
                >
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Full bathroom</span>
                </button>
                <button className="phototour-element-2" type="button" aria-label="Gym">
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Gym</span>
                </button>
                <button className="phototour-element-2" type="button" aria-label="Exterior">
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Exterior</span>
                </button>
                <button className="phototour-element-2" type="button" aria-label="Pool">
                  <img
                    loading="lazy"
                    alt=""
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Pool</span>
                </button>
                <button
                  className="phototour-element-2"
                  type="button"
                ...
                >
                  <img
                    ...
                    src="/photos/tour/living-room-1/living-room-1-01-wide-angle.jpeg"
                  />
                  <span className="hostsection-rating">Additional photos</span>
                </button>
              </nav>
              <div className="tour-rooms" id="tourRooms">
                <section className="phototour-div" id="tour-room-0">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Living room 1</div>
                    <div className="phototour-div-10">
                      Sofa · Air conditioning · Ceiling fan · TV
                    </div>
                  </div>
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        className="phototour-element"
                        type="button"
                        data-idx="1"
                ...
                <section className="phototour-div" id="tour-room-1">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Living room 2</div>
                    <div className="phototour-div-10">Ceiling fan · Hot tub</div>
                  </div>
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="5"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 6"
                      >
                        <img
                          loading="lazy"
                          alt="Living room 2"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="6"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 7"
                      >
                        <img
                          loading="lazy"
                          alt="Living room 2"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="7"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 8"
                      >
                        <img
                          loading="lazy"
                          alt="Living room 2"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="8"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 9"
                      >
                        <img
                          loading="lazy"
                          alt="Living room 2"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="9"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 10"
                      >
                        <img
                          loading="lazy"
                          alt="Living room 2"
                ...
                <section className="phototour-div" id="tour-room-2">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Full kitchen</div>
                    <div className="phototour-div-10">
                  ...
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="10"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 11"
                      >
                        <img
                          loading="lazy"
                          alt="Full kitchen"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="11"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 12"
                      >
                        <img
                          loading="lazy"
                          alt="Full kitchen"
                ...
                <section className="phototour-div" id="tour-room-3">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Bedroom</div>
                    <div className="phototour-div-10">
                      Double bed · Air conditioning · Bed linen · Ceiling fan ·
                      Clothes storage · Cot · Hangers · Iron · Room-darkening
                      blinds · Cleaning available during stay · Cleaning
                  ...
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="12"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 13"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="13"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 14"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="14"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 15"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="15"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 16"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="16"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 17"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="17"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 18"
                      >
                        <img
                          loading="lazy"
                          alt="Bedroom"
                ...
                <section className="phototour-div" id="tour-room-4">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Full bathroom</div>
                    <div className="phototour-div-10">
                  ...
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="18"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 19"
                      >
                        <img
                          loading="lazy"
                          alt="Full bathroom"
                ...
                <section className="phototour-div" id="tour-room-5">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Gym</div>
                    <div className="phototour-div-10">
                  ...
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="19"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 20"
                      >
                        <img
                          loading="lazy"
                          alt="Gym"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="20"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 21"
                      >
                        <img
                          loading="lazy"
                          alt="Gym"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="21"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 22"
                      >
                        <img
                          loading="lazy"
                          alt="Gym"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="22"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 23"
                      >
                        <img
                          loading="lazy"
                          alt="Gym"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="23"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 24"
                      >
                        <img
                          loading="lazy"
                          alt="Gym"
                ...
                <section className="phototour-div" id="tour-room-6">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Exterior</div>
                  </div>
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="24"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 25"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="25"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 26"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="26"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 27"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="27"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 28"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="28"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 29"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="29"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 30"
                      >
                        <img
                          loading="lazy"
                          alt="Exterior"
                ...
                <section className="phototour-div" id="tour-room-7">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Pool</div>
                    <div className="phototour-div-10">Pool</div>
                  </div>
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="30"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 31"
                      >
                        <img
                          loading="lazy"
                          alt="Pool"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="31"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 32"
                      >
                        <img
                          loading="lazy"
                          alt="Pool"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="32"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 33"
                      >
                        <img
                          loading="lazy"
                          alt="Pool"
                ...
                <section className="phototour-div" id="tour-room-8">
                  <div className="phototour-div-13">
                    <div className="phototour-h2">Additional photos</div>
                  </div>
                  <div className="phototour-div-5">
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="33"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 34"
                      >
                        <img
                          loading="lazy"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="34"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 35"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="35"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 36"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="36"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 37"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="37"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 38"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="38"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 39"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="39"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 40"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                    ...
                    <div className="phototour-div-12 phototour-div-2">
                      <button
                        ...
                        type="button"
                        data-idx="40"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 41"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                      ...
                      <button
                        ...
                        type="button"
                        data-idx="41"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 42"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
                    ...
                    <div className="phototour-div-12 phototour-div-11">
                      <button
                        ...
                        type="button"
                        data-idx="42"
                        aria-label="Romantic Jacuzzi 1BHK Candolim | Mirashya UG10 image 43"
                      >
                        <img
                          loading="lazy"
                          alt="Additional photos"
        ...
        >
          <header className="app-header">
            <button
              className="app-element phototour-close"
              type="button"
            ...
            <div className="app-lbtitle" id="lbTitle"></div>
            <div className="app-div-11">
              <span className="app-lbcounter" id="lbCounter"></span>
              <button
                className="lb-close phototour-close"
                type="button"
                aria-label="Close"
                id="lbClose"
              >
          ...
          <button
            className="app-element-3 app-element-4 phototour-close"
            type="button"
            aria-label="Previous"
            id="lbPrev"
            disabled=""
          ...
          <div className="app-lbstage" id="lbStage"></div>
          <button
            className="app-element-3 app-element-5 phototour-close"
            type="button"
            aria-label="Next"
            id="lbNext"
            disabled=""
        ...
        <div className="app-amenmodal" id="amenModal" aria-hidden="true">
          <div
            className="app-element-8"
            role="dialog"
            aria-modal="true"
            aria-label="What this place offers"
          >
            <div className="app-div-17">
              <button
                className="phototour-close app-element-7"
                type="button"
                aria-label="Close"
                id="amenClose"
              >
            ...
            <div className="app-amenbody" id="amenBody">
              <h2>What this place offers</h2>
              <div className="app-div-10">
                <h3>Bathroom</h3>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 32 32"
                  ...
                  <span className="label">Hairdryer</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Cleaning products</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Shower gel</span>
                </div>
              </div>
              <div className="app-div-10">
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Washing machine</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Hangers</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Bed linen</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Room-darkening blinds</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Clothes storage</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
              ...
              <div className="app-div-10">
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Ceiling fan</span>
                </div>
              </div>
              <div className="app-div-10">
                <h3>Home safety</h3>
                ...
                <div className="app-div-8 amenitiessection-div">
                  <span className="ico">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 32 32"
              ...
              <div className="app-div-10">
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Freezer</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Microwave</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Cooking basics</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Crockery and cutlery</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Kettle</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Wine glasses</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Toaster</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Cooker</span>
                </div>
              </div>
              <div className="app-div-10">
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Private entrance</span>
                </div>
              </div>
              <div className="app-div-10">
                <h3>Outdoor</h3>
                <div className="app-div-8">
                  ...
                  <span className="label">Patio or balcony</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Outdoor dining area</span>
                </div>
              </div>
              <div className="app-div-10">
              ...
              <div className="app-div-10">
                ...
                <div className="app-div-8">
                  ...
                  <span className="label">Cleaning available during stay</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Long-term stays allowed</span>
                </div>
                <div className="app-div-8">
                  <span className="ico">
                    <svg
                  ...
                  <span className="label">Self check-in</span>
                </div>
              </div>
            </div>
          </div>
        </div>
        <div className="app-haloyx" id="app-haloyx" role="status" aria-live="polite">
          Saved to wishlist
        </div>
      </div>
